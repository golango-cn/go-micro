...
func (l *Logger) loadCfg() {
	...
	l.Opts = &Options{
		Config:        config.AppConfig.App.Zap.Config,
		LogFileDir:    config.AppConfig.App.Zap.LogFileDir,
		AppName:       config.AppConfig.App.Zap.AppName,
		ErrorFileName: config.AppConfig.App.Zap.ErrorFileName,
		WarnFileName:  config.AppConfig.App.Zap.WarnFileName,
		InfoFileName:  config.AppConfig.App.Zap.InfoFileName,
		DebugFileName: config.AppConfig.App.Zap.DebugFileName,
		MaxSize:       config.AppConfig.App.Zap.MaxAge,
		MaxBackups:    config.AppConfig.App.Zap.MaxBackups,
		MaxAge:        config.AppConfig.App.Zap.MaxAge,
	}
